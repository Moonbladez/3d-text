...
const donutMatcapTexture = textureLoader.load("/textures/matcaps/3.png");
...
let quote = `"A girl should be two things: 
who and what she wants."
`;
const font = loader.load(
    // resource URL
    "fonts/Bai _Regular.json",

    (font) => {
        const textGeometry = new TextGeometry(quote, {
            font: font,
            size: 3,
            height: 1,
            curveSegments: 5,
